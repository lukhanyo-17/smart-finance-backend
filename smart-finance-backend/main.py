...
EMAIL_ALERTS_ENABLED = os.getenv("EMAIL_ALERTS_ENABLED", "False") == "True"
...
def send_email_alert(transaction: Transaction):
    ...
    try:
        with smtplib.SMTP('localhost') as smtp:
            ...
            smtp.sendmail(FROM_EMAIL, ALERT_EMAIL, message)
...
def user_insights(user_id: str):
    ...
    return {
        ...
        "advice": "Consider budgeting for high-spend categories like " + max(by_category, key=by_category.get) if by_category else ""
    }
